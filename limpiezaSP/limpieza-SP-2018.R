...
dirData <- "C:/wilgen/saber pro/SP_2018.TXT"
outputDir <- "C:/wilgen/data_limpia_SP/SP_2018.csv"
outputDirTXT <- "C:/wilgen/data_limpia_SP/SP_2018.TXT"
...
names(data)
mantener_columnas <- c(3,4,7,9,12,14,61,62,63,70,81,85,89,93,97,101)
