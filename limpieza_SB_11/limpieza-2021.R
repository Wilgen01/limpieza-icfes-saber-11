...
## importar data
periodo1 <- read_delim("C:/wilgen/saber 11/SB11_20211.TXT", 
                       delim = "¬", escape_double = FALSE, 
                       trim_ws = TRUE)
periodo2 <- read_delim("C:/wilgen/saber 11/SB11_20212.TXT", 
                       delim = "¬", escape_double = FALSE, 
                       trim_ws = TRUE)
...
names(data_limpiap1)
write.csv(data_limpiap1, "C:/wilgen/data_limpia/SB11_20211.TXT")
...
names(data_limpiap2)
write.csv(data_limpiap2, "C:/wilgen/data_limpia/SB11_20212.TXT")
