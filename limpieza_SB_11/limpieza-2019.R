...
## importar data
periodo1 <- read_delim("C:/wilgen/saber 11/SB11_20191.TXT", 
                       delim = "|", escape_double = FALSE, 
                       trim_ws = TRUE)
periodo2 <- read_delim("C:/wilgen/saber 11/SB11_20192.TXT", 
                       delim = "¬", escape_double = FALSE, 
                       trim_ws = TRUE)
...
names(data_limpiap1)
write.csv(data_limpiap1, "C:/wilgen/data_limpia/SB11_20191.TXT")
...
names(data_periodo2$punt)
mantener_columnas_p2 <- c(3,4,6,9,11,13,61,64,67,70,73,76)
data_limpiap2 <- data_periodo2[mantener_columnas_p2]
names(data_limpiap2)
write.csv(data_limpiap2, "C:/wilgen/data_limpia/SB11_20192.TXT")
