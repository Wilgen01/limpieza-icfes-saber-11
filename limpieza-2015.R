...
## definir directorios
dirData1 <- "D:/seminario/saber 11/SB11_20151.TXT"
outputDir1 <- "D:/seminario/data_limpia/SB11_20151.TXT"
dirData2 <- "D:/seminario/saber 11/SB11_20152.TXT"
outputDir2 <- "D:/seminario/data_limpia/SB11_20152.TXT"
...
names(data_periodo1$punt)
mantener_columnas_p1 <- c(3,4,6,8,16,18,111,113,115,117,119,121,123,126)
...
names(data_periodo2)
mantener_columnas_p2 <- c(3,4,6,8,17,19,69,71,73,75,77,79,81,84)
